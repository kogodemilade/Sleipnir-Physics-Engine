...
//         engine.drawMesh(head, view, projection, cam.getCameraPos(), b.getPosandOrient().toGlm());


//         glm::vec3 bPos = b.getPosition().toGlm();
//         glm::vec3 planePoint = ground.getPosition().toGlm();
//         glm::vec3 n = glm::normalize(groundPlane.normal.toGlm());

//         // signed distance from b to plane
//         float d = glm::dot(bPos - planePoint, n);

//         // projection of b onto the plane
//         glm::vec3 p1 = bPos - d * n;
